...
from .io import uppasd_jfile_text
...
def _uppasd_jfile_text(workflow: FrozenMagnonWorkflow) -> str:
    ...
    return uppasd_jfile_text(workflow.transform_result.vectors, workflow.transform_result.jij_mry, workflow.structure)
        ...
        [
            ...
            html.Div(
                [
                    html.Div(
                        [
                            html.Div("FourJ", className="wordmark"),
